...
import config
import os
from dhit_ic.lib import HITGeneratorGivenSpectrum
...
E_42 = exp_data['E_42'][0] / 1e6   # (config.u_ref**2 * config.L_ref)
k_98 = exp_data['k_98'][0] * 1e2  # config.L_ref
E_98 = exp_data['E_98'][0] / 1e6  # (config.u_ref**2 * config.L_ref)
k_171 = exp_data['k_171'][0] * 1e2  # config.L_ref
E_171 = exp_data['E_171'][0] / 1e6  # (config.u_ref**2 * config.L_ref)
