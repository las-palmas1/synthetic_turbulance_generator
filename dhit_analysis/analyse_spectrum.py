...
def plot_initial_spectrum():
    ...
    plt.plot(spectrum.k_mag, spectrum.e_k_mag, lw=1.2, color='black', label=r'$t = 0$')
...
if __name__ == '__main__':
    ...
    # lazurit_energy_arr = get_kinetic_energy_arr(config.num, lazurit_frames)
